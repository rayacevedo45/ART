 ...
 */
public class CardsListFragment  extends ListFragment implements View.OnClickListener {
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        for (int i = 0, z = Cards.CARDS.length ; i < z ; i++) {
            items.add(Cards.CARDS[i]);
        }
        // Set the ListAdapter
    ...
    class PopupAdapter extends ArrayAdapter<String> {
        ...
        PopupAdapter(ArrayList<String> items) {
            super(getActivity(), R.layout.list_cards, android.R.id.text1, items);
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            popupButton.setOnClickListener(CardsListFragment.this);
